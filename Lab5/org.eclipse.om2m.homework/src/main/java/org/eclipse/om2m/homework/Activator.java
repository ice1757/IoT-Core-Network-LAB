...
import org.eclipse.om2m.homework.hw_ipeRouter;
...
public class Activator implements BundleActivator {
	...
	public void start(BundleContext bundleContext) throws Exception {
        ...
        bundleContext.registerService(InterworkingService.class.getName(), new hw_ipeRouter(), null);
        ...
        cseServiceTracker = new ServiceTracker<Object, Object>(bundleContext, CseService.class.getName(), null) {
            ...
            public Object addingService(ServiceReference<Object> reference) {
                ...
                hw_ipeController.setCse(cseService);
                // create Resource in mn-cse
                Func.createResources(hw_ipeConstants.AE_NAME, hw_ipeConstants.POA);
                return cseService;
            }
        };
